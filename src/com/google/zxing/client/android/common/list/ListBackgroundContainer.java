...
public class ListBackgroundContainer extends FrameLayout {
    ...
    public ListBackgroundContainer(Context context) {
        super(context);
        init();
    }

    public ListBackgroundContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ListBackgroundContainer(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() {
        mShadowedBackground = getContext().getResources().getDrawable(R.drawable.animated_list_item_background);
    }
